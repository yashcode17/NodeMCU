...
const char* ssid = "yashu"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "0987654321y"; // Your Wifi password, in case you have open network comment the whole statement.
